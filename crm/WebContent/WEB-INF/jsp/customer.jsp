...
<%@ taglib prefix="yyf" uri="http://yyf.crm/common/" %>
<!DOCTYPE HTML>
<html>
<head>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="post" 
				      action="${pageContext.request.contextPath }/customer/list.do">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="col-md-12 text-right">
						<yyf:page url="${pageContext.request.contextPath }/customer/list.do"></yyf:page>
						<%-- 分页标签 --%>
					</div>
					<!-- /.panel-body -->
				</div>
...
//清空新建客户窗口中的数据
	...
	$.post("${pageContext.request.contextPath}/customer/create.do",
	...
	function editCustomer(id) {
	    $.ajax({
	        type:"get",
	        url:"${pageContext.request.contextPath}/customer/getCustomerById.do",
	        data:{"id":id},
	...
	function updateCustomer() {
		$.post("${pageContext.request.contextPath}/customer/update.do",$("#edit_customer_form").serialize(),function(data){
			if(data =="OK"){
				alert("客户信息更新成功！");
				window.location.reload();
			}else{
	...
	$.post("${pageContext.request.contextPath}/customer/delete.do",{"id":id},
	function(data){
	            if(data =="OK"){
	                alert("客户删除成功！");
	                window.location.reload();
